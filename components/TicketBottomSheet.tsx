...
const TicketBottomSheet = forwardRef<PlaceBottomSheetRef>(({ selectedEvent, setFilteredBook, setBook, updateCheckinStatus }, ref) => {
                            ...
                            >
                                <View style={styles.placeDetails}>
                                    <View style={styles.rightContainer}>
                                        ...
                                        <Text style={styles.checkedInCount}>{selectedEvent?.firstName}</Text>
                                    </View>
                                </View>
                                    ...
                                    <View style={styles.rightContainer}>
                                        ...
                                        <Text style={styles.checkedInCount}>
                                            {selectedEvent?.amount < 0
                                                ? `-$${(Math.abs((selectedEvent?.amount / 100) - 0.89) / 1.09).toLocaleString("en-US", {
                            ...
                            >
                                <View style={styles.placeDetails}>
                                    <View style={styles.rightContainer}>
                                        ...
                                        <Text style={styles.checkedInCount}>{selectedEvent?.payment_method || "-"}</Text>
                                    </View>
                                </View>
                                <View style={styles.placeIcon}>
                                    <Image
                                ...
                                selectedEvent?.qr_status === 'true' ?
                                    (
                                        <View style={styles.buttonContainer}>
                                            <TouchableOpacity style={styles.confirmCheckInButton} onPress={() => updateCheckinStatus(selectedEvent._id, selectedEvent.qr_status)}>
                                                <Text style={styles.confirmCheckInText}>Undo check-in</Text>
                                            </TouchableOpacity>
                                        </View>
                                    ) : (
                                        <View style={styles.buttonContainer}>
                                            <TouchableOpacity style={[styles.confirmCheckInButton, { backgroundColor: "white" }]} onPress={() => updateCheckinStatus(selectedEvent._id, selectedEvent.qr_status)}>
                                                <Text style={[styles.confirmCheckInText, { color: "balck" }]}>Check in</Text>
                                            </TouchableOpacity>
                                        </View>
                                    )
                            }
