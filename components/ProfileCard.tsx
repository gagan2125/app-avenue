          ...
          <>
            <View className="mb-10">
              <Pressable
                ...
                style={{ backgroundColor: profileImage ? "#10B981" : "#10B981" }}
          ...
          >
            ...
            <View className="mt-4 flex-row justify-between bg-black rounded-3xl p-4 border border-white/10">
              <View className="flex-1 flex-col items-center">
                <Text className="text-sm text-gray-400">Live events</Text>
              ...
              <View className="flex-1 flex-col items-center">
                <Text className="text-sm text-gray-400">Past events</Text>
                <Text className="text-2xl mt-2 font-semibold text-white">
                  {savedTickets}
                </Text>
              </View>
